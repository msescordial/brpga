function [S0,S0r] = generateInitialRouteSet(netCostMatrix, BusRouteID, TotalNoOfRoutes, s, min_route_length)
    ...
    while (stop == 0)
        ...
        while (a <= s)
            ...
            if (length(route) >= min_route_length)     % constraint - route length             
